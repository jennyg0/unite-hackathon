          ...
          <div className="text-center mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div className="bg-white rounded-lg p-4 border border-red-200">
                  <div className="flex items-center justify-center space-x-1 mb-2">
                    ...
                    <span className="text-sm text-red-600 font-medium">Bank Interest</span>
                  </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-red-200">
                  <div className="flex items-center justify-center space-x-1 mb-2">
                    ...
                    <span className="text-sm text-red-600 font-medium">Inflation Rate</span>
                  </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-red-200">
                  <div className="flex items-center justify-center space-x-1 mb-2">
                    ...
                    <span className="text-sm text-red-600 font-medium">You've Lost</span>
                  </div>
                  <div className="text-2xl font-bold text-red-900">
                    ${lostMoney.toFixed(2)}
                  </div>
                  <div className="text-xs text-red-600">since visiting this page</div>
                </div>
              </div>
              
              <p className="text-red-700 mt-4 text-lg font-medium">
                You're losing <span className="font-bold">3.19%</span> of your purchasing power every year
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-700 mb-8 font-medium">
                Earn <span className="text-green-600 font-bold">8-15% APY</span> automatically
                <br />
                <span className="text-lg text-gray-600">While you sleep. Withdraw anytime.</span>
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="bg-gray-100 rounded-xl p-6 border-2 border-gray-200">
                <h3 className="text-lg font-semibold text-gray-700 mb-4">Traditional Bank</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Real value (inflation):</span>
              ...
              <div className="bg-green-100 rounded-xl p-6 border-2 border-green-300 relative">
                ...
                <h3 className="text-lg font-semibold text-green-700 mb-4 mt-2">Smart Savings</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="text-green-700">Real value (inflation):</span>
            ...
            >
              ...
              >
                ...
                <span>Fix This in 30 Seconds</span>
          ...
          >
            <div className="flex items-center justify-center space-x-8 text-center">
              <div>
                ...
                <div className="text-sm text-gray-600">Protected from inflation</div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-900">Audited & Secure</div>
                  <div className="text-xs text-gray-600">Smart contract verified</div>
                </div>
              </div>
            </div>
          </motion.div>
